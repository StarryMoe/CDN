...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//fastly.jsdelivr.net/gh/StarryMoe/CDN/goindex-extended/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//fastly.jsdelivr.net/gh/StarryMoe/CDN/goindex-extended/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//fastly.jsdelivr.net/gh/StarryMoe/CDN/goindex-extended/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//fastly.jsdelivr.net/gh/StarryMoe/CDN/goindex-extended/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="//fastly.jsdelivr.net/gh/StarryMoe/CDN/goindex-extended/mdui.min.js"></script>'
);
document.write(
  '<script src="//fastly.jsdelivr.net/gh/StarryMoe/CDN/goindex-extended/flv.min.js"></script>'
);
document.write(
  '<script src="//fastly.jsdelivr.net/gh/StarryMoe/CDN/goindex-extended/DPlayer.min.js"></script>'
);
document.write(
  '<script src="//fastly.jsdelivr.net/gh/StarryMoe/CDN/goindex-extended/markdown-it.min.js"></script>'
);
document.write(
